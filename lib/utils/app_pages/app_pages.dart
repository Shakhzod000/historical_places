...
import 'package:historical_places/pages/regions/regions_binding.dart';
...
mixin AppRoutes on StatelessWidget {
  static final List<GetPage> appPages = [
    GetPage(
        name: AppPageRoutesName.mainView.route,
        page: () => const MainView(),
        binding: MainaBinding()),
    GetPage(
        name: AppPageRoutesName.homeView.route,
        page: () => const HomeView(),
        binding: HomeBinding()),
    GetPage(
        name: AppPageRoutesName.searchView.route,
        page: () => const SearchView(),
        binding: SearchBinding()),
    GetPage(
        name: AppPageRoutesName.regionView.route,
        page: () => const RegionView(),
        binding: RegionsBinding()),
    GetPage(
        name: AppPageRoutesName.saveView.route,
        page: () => const SaveView(),
        binding: SaveBinding()),
    GetPage(
        name: AppPageRoutesName.settingView.route,
